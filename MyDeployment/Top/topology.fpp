module MyDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "MyDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup1.RateGroupMemberOut[5] -> uartDrv.run
    ...
    connections LCDTransport {
      lcdDisplay.uartWrite -> uartDrv.$send
      lcdDisplay.deallocate -> uartBufMgr.bufferSendIn
      uartDrv.$recv -> lcdDisplay.$recv
      uartDrv.allocate -> uartBufMgr.bufferGetCallee
      uartDrv.deallocate -> uartBufMgr.bufferSendIn
    }
