// ======================================================================
// \title  MathReceiverTester.cpp
// \author otsii
// \brief  cpp file for MathReceiver component test harness implementation class
// ======================================================================
#define CMD_SEQ 42
...
MathReceiverTester ::MathReceiverTester()
    : MathReceiverGTestBase("MathReceiverTester", MathReceiverTester::MAX_HISTORY_SIZE), component("MathReceiver") {
    this->initComponents();
    this->connectPorts();
}
