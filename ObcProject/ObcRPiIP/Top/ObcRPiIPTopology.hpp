// ======================================================================
// \title  ObcRPiIPTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef OBCRPIIP_OBCRPIIPTOPOLOGY_HPP
#define OBCRPIIP_OBCRPIIPTOPOLOGY_HPP
// Included for access to ObcRPiIP::TopologyState and ObcRPiIP::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ObcProject/ObcRPiIP/Top/ObcRPiIPTopologyDefs.hpp>
 ...
 * ObcRPiIP::TopologyState see: ObcRPiIPTopologyDefs.hpp.
 *
