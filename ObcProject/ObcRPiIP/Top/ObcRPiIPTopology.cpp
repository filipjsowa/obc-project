// ======================================================================
// \title  ObcRPiIPTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <ObcProject/ObcRPiIP/Top/ObcRPiIPTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <ObcProject/ObcRPiIP/Top/ObcRPiIPPacketsAc.hpp>
...
// The reference topology divides the incoming clock signal (10Hz) into sub-signals: (20/20)Hz, 2021Hz, and 20/80Hz with 0 offset
Svc::RateGroupDriver::DividerSet rateGroupDivisorsSet{{{20, 0}, {1, 0}, {80, 0}}};
