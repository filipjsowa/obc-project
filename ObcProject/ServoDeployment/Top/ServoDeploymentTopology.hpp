// ======================================================================
// \title  ServoDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SERVODEPLOYMENT_SERVODEPLOYMENTTOPOLOGY_HPP
#define SERVODEPLOYMENT_SERVODEPLOYMENTTOPOLOGY_HPP
// Included for access to ServoDeployment::TopologyState and ServoDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ObcProject/ServoDeployment/Top/ServoDeploymentTopologyDefs.hpp>
 ...
 * ServoDeployment::TopologyState see: ServoDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ObcProject::TopologyState see: ObcProjectTopologyDefs.hpp.
 *
