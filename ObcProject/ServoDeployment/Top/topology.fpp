module ObcProject {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "ServoDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections ServoDeployment {
      CdhCore.cmdDisp.compCmdSend[0] -> servoComponent.cmdIn
      servoComponent.cmdResponseOut -> CdhCore.cmdDisp.compCmdStat[0]
    }
