# ServoDeployment Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the ServoDeployment Application

In order to build the ServoDeployment application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:
...
The next step is to build the ServoDeployment application's code.
```
fprime-util build
```
